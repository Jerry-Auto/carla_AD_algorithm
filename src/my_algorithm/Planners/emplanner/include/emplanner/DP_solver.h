...
#include "emplanner/DP_tamplate.h"      // 移除 planner/emplanner.h
#include "emplanner/DP_algorithm.hpp"   // 添加模板实现
#include "general_modules/common_types.h"  // 添加通用类型包含
...
private:
    ...
    std::vector<general::SLObstacle> _static_obstacles;
public:
...
private:
    ...
    std::vector<general::STObstacle> _st_obstacles;
