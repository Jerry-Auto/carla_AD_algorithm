...
int main() {
    ...
    std::vector<general::Obstacle> obstacles;
    {
        ...
        general::Obstacle obs_left; obs_left.id = 104; obs_left.x = 120.0; obs_left.y = 2.5; obs_left.vx = 0.0; obs_left.vy = 0.0; obs_left.length = 4.5; obs.width = 2.0; obstacles.push_back(obs_left);
    ...
    std::cout << "CILQR test completed." << std::endl;
    return 0;
}